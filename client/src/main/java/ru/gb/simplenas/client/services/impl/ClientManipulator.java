...
public class ClientManipulator implements Manipulator
{
                              ...
                              SocketChannel sC)
    {
        ...
        this.schannel = sC;
        new Thread(this::buildMethodMaps).start();
    ...
    @ManipulateMethod (opcodes = {OperationCodes.LIST})
    ...
    private void manipulateLoad2LocalQueue (NasMsg nm)
    {
    ...
    private void endupLoad2LocalRequest (NasMsg nm)
    {
    ...
    private void manipulateLoad2ServerQueue (NasMsg nm)
    {
